...
function filterProductsName(ele) {
    ...
    for (var i = 0; i < listLi.length; i++) {
        if (getNameFromLi(listLi[i]).toUpperCase().indexOf(filter) > -1 && soLuong < soLuongSanPhamMaxTrongMotTrang) {
            showLi(listLi[i]);
            coSanPham = true;
            soLuong++;
        } else {
...
function addPricesRange(min, max) {
    ...
    document.getElementsByClassName("pricesRangeFilter")[0].getElementsByClassName("dropdown-content")[0].innerHTML += mucgia;
}
...
function addPromotion(name) {
    ...
    document.getElementsByClassName("promosFilter")[0].getElementsByClassName("dropdown-content")[0].innerHTML += promo;
}
...
function addStarFilter(value) {
    ...
    document.getElementsByClassName("starFilter")[0].getElementsByClassName("dropdown-content")[0].innerHTML += star;
}
...
function addSortFilter(type, nameFilter, text) {
    ...
    document.getElementsByClassName("sortFilter")[0].getElementsByClassName("dropdown-content")[0].innerHTML += sortTag;
}
